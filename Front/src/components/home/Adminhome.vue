<template>
  <el-row>
    <el-col :span="12">
      <el-table :data="adminData.adminList" border style="width: 100%">
        <el-table-column prop="aname" label="用户名" width="180">
        </el-table-column>
        <el-table-column prop="asex" label="性别" width="180">
        </el-table-column>
        <el-table-column prop="aage" label="年龄" width="180">
        </el-table-column>
        <el-table-column prop="atelephone" label="联系方式"> </el-table-column>
      </el-table>
      <el-table :data="adminData.adminList" border style="width: 100%">
        <el-table-column prop="adepartment" label="职位" width="180">
        </el-table-column>
        <el-table-column prop="aaddress" label="联系地址"> </el-table-column>
        <el-table-column>
...
export default {
  data() {
    return {
      ...
      value: new Date(),
      adminusername: window.localStorage.getItem("adminusername"),
      adminpassword: window.localStorage.getItem("adminpassword"),
  ...
  mounted() {
    this.loginadminList(this.adminusername, this.adminpassword);
  },
  methods: {
    ...
    async loginadminList(adminusername, adminpassword) {
      const { data } = await axios({
        url: "/admins/loginadminList",
        method: "post",
        data: {
          adminusername,
          adminpassword,
